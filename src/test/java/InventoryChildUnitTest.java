...
public class InventoryChildUnitTest {
    ...
    public static void setUpClass() throws SQLException, GuanzonException, IOException {
        ...
        poController = new InvControllers(instance, null).InventoryChildUnit();
    ...
    public void testUpdateDeactivateActivate() throws Exception {
        ...
        List<org.guanzon.cas.inv.model.Model_Inventory_Child_Unit> targetRows = new ArrayList<>();
        ...
        List<org.guanzon.cas.inv.model.Model_Inventory_Child_Unit> activateRows = new ArrayList<>();
...
//    }
    ...
    public void testStatusValidationPaths() throws Exception {
        ...
        org.guanzon.cas.inv.model.Model_Inventory_Child_Unit detail = poController.Detail(0);
        List<org.guanzon.cas.inv.model.Model_Inventory_Child_Unit> rows = new ArrayList<>();
        rows.add(detail);
